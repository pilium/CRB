...
window.addEventListener('load', function () {
  ...
  var modalOverlay = document.querySelector('.modal-overlay'); // modal--alert

  var teees = document.querySelector('.teeest');
  var modalAlert = document.querySelector('.modal--alert');
  var modalAlertClose = document.querySelector('.modal--alert__close');
  var modalAlertOverlay = document.querySelector('.modal--alert__background'); // Modal
  ...
  var modalAlertInit = function modalAlertInit() {
    teees.addEventListener('click', function (event) {
      event.preventDefault();
      modalAlert.classList.toggle('is-active');
      modalAlertOverlay.classList.toggle('is-show');
    });
    modalAlertClose.addEventListener('click', function (event) {
      event.preventDefault();
      modalAlert.classList.toggle('is-active');
      modalAlertOverlay.classList.toggle('is-show');
    });
